...
Relational is for storing updating and accessed SQL is used to access info stored in database

- [ ] Why do tables need a `primary key`?
They are unique identifiers assigned to piece of data being stored
...
Bridge table with foreign key to link to primary key of other tables
